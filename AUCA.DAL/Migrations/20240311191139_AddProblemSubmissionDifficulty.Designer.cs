...
namespace BusinessBanking.DAL.Migrations
{
    ...
    [Migration("20240311191139_AddProblemSubmissionDifficulty")]
    partial class AddProblemSubmissionDifficulty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessBanking.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDate = new DateTime(2024, 3, 12, 1, 11, 39, 272, DateTimeKind.Local).AddTicks(7298),
                            IsEnabled = true,
                            Login = "user",
